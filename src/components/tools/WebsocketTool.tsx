...
export default function WebsocketTool() {
  ...
  return (
    <div className="relative flex h-full min-h-[600px] bg-white overflow-hidden text-slate-900">
      ...
      <div
        className={`absolute top-0 -right-5 h-full bg-white border-l border-slate-200 shadow-2xl flex flex-col shrink-0 overflow-hidden transition-all duration-300 ease-in-out z-50 ${showHistory ? "w-80 translate-x-0" : "w-80 translate-x-full"}`}
      >
